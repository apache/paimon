...
/** Vector search global index result for ES (Lucene HNSW) vector index. */
public class ESScoredGlobalIndexResult implements ScoredGlobalIndexResult {

    private final RoaringNavigableMap64 results;
    private final HashMap<Long, Float> id2scores;

    public ESScoredGlobalIndexResult(
