...
public class StringToBinaryCastExecutor implements CastExecutor<StringData, byte[]> {
    private final int targetLength;

    public StringToBinaryCastExecutor(int targetLength) {
    ...
    public byte[] cast(@Nullable StringData value) throws TableException {
        ...
        byte[] byteArrayTerm = value.toBytes();
