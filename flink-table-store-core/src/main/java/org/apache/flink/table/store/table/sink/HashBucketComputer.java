...
public class HashBucketComputer implements BucketComputer {
    ...
    public HashBucketComputer(TableSchema tableSchema) {
        this(
    ...
    private HashBucketComputer(
            int numBucket, RowType rowType, int[] bucketKeys, int[] primaryKeys) {
