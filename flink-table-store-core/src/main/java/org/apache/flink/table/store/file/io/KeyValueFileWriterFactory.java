...
public class KeyValueFileWriterFactory {
    ...
    public KeyValueDataRollingFileWriter createLeveledWriter(int level) {
        return new KeyValueDataRollingFileWriter(
                () -> createLeveledWriterImpl(level), suggestedFileSize);
    }
