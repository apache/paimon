...
public class LogicalTypeToDataType extends LogicalTypeDefaultVisitor<DataType> {
    ...
    public DataType visit(BooleanType booleanType) {
        return new org.apache.flink.table.store.file.schema.BooleanType(booleanType.isNullable());
    }
    ...
    public DataType visit(TinyIntType tinyIntType) {
        return new org.apache.flink.table.store.file.schema.TinyIntType(tinyIntType.isNullable());
    }

    @Override
    public DataType visit(SmallIntType smallIntType) {
        return new org.apache.flink.table.store.file.schema.SmallIntType(smallIntType.isNullable());
    }

    @Override
    public DataType visit(IntType intType) {
        return new org.apache.flink.table.store.file.schema.IntType(intType.isNullable());
    }

    @Override
    public DataType visit(BigIntType bigIntType) {
        return new org.apache.flink.table.store.file.schema.BigIntType(bigIntType.isNullable());
    }

    @Override
    public DataType visit(FloatType floatType) {
        return new org.apache.flink.table.store.file.schema.FloatType(floatType.isNullable());
    }

    @Override
    public DataType visit(DoubleType doubleType) {
        return new org.apache.flink.table.store.file.schema.DoubleType(doubleType.isNullable());
    }

    @Override
    public DataType visit(DateType dateType) {
        return new org.apache.flink.table.store.file.schema.DateType(dateType.isNullable());
    }
