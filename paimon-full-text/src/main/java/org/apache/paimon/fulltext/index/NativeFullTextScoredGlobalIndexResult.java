...
/** Native full-text search global index result. */
public class NativeFullTextScoredGlobalIndexResult implements ScoredGlobalIndexResult {

    private final RoaringNavigableMap64 results;
    private final Map<Long, Float> id2scores;

    public NativeFullTextScoredGlobalIndexResult(
