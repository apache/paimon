...
public class COSNLoader implements FileIOLoader {
    ...
    private static final String COSN_CLASSES_DIR = "paimon-plugin-cosn";
    ...
    private static synchronized PluginLoader getLoader() {
        if (loader == null) {
            ...
            loader = new PluginLoader(COSN_CLASSES_DIR);
        }
        return loader;
    }
    ...
    public List<String[]> requiredOptions() {
        ...
        options.add(new String[] {"fs.cosn.bucket.endpoint_suffix"});
