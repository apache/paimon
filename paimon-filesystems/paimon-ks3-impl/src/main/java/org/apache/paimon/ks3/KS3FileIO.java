...
public class KS3FileIO extends HadoopCompliantFileIO {
     ...
     */
    private static final String[] CONFIG_PREFIXES = {"fs.ks3."};

    private static final String KS3_ACCESS_KEY_ID = "fs.ks3.AccessKey";
    private static final String KS3_ACCESS_KEY_SECRET = "fs.ks3.AccessSecret";
    private static final String KS3_SECURITY_TOKEN = "fs.ks3.securityToken";

    private static final Map<String, String> CASE_SENSITIVE_KEYS =
            new HashMap<String, String>() {
                {
                    put(KS3_ACCESS_KEY_ID.toLowerCase(), KS3_ACCESS_KEY_ID);
                    put(KS3_ACCESS_KEY_SECRET.toLowerCase(), KS3_ACCESS_KEY_SECRET);
                    put(KS3_SECURITY_TOKEN.toLowerCase(), KS3_SECURITY_TOKEN);
                }
            };
