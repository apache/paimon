...
public class OBSFileIO extends HadoopCompliantFileIO {
    ...
    private static final String OBS_ACCESS_KEY_ID = Constants.ACCESS_KEY;
    private static final String OBS_ACCESS_KEY_SECRET = Constants.SECRET_KEY;
    private static final String OBS_SESSION_TOKEN = Constants.SESSION_TOKEN;

    private static final Map<String, String> CASE_SENSITIVE_KEYS =
            new HashMap<String, String>() {
                {
                    put(OBS_ACCESS_KEY_ID, OBS_ACCESS_KEY_ID);
                    put(OBS_ACCESS_KEY_SECRET, OBS_ACCESS_KEY_SECRET);
                    put(OBS_SESSION_TOKEN, OBS_SESSION_TOKEN);
                }
            };
