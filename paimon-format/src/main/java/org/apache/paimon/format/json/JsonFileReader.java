...
public class JsonFileReader extends AbstractTextFileReader {
    ...
    private Object convertJsonValue(JsonNode node, DataType dataType, JsonOptions options) {
        ...
        switch (dataType.getTypeRoot()) {
            ...
            case VECTOR:
                return convertJsonVec(node, (VecType) dataType, options);
            case MAP:
    ...
    private ArrayBasedVec convertJsonVec(JsonNode vecNode, VecType vecType, JsonOptions options) {
        ArrayType arrayType = DataTypes.ARRAY(vecType.getElementType());
        GenericArray array = convertJsonArray(vecNode, arrayType, options);
