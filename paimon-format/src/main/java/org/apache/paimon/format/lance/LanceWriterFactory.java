...
import org.apache.paimon.format.lance.common.ArrowBundleWriter;
...
public class LanceWriterFactory implements FormatWriterFactory, SupportsDirectWrite {
    ...
    public LanceWriterFactory(Supplier<ArrowFormatCWriter> arrowFormatWriterSupplier) {
