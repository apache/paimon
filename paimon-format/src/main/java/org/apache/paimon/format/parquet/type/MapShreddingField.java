...
public class MapShreddingField extends ParquetGroupField {
    ...
    private final List<ParquetField> sidecarFields;
    private final List<BinaryString> sidecarKeys;

    public MapShreddingField(
            DataType type,
            ParquetGroupField residualMapField,
            List<ParquetField> sidecarFields,
            List<BinaryString> sidecarKeys) {
        super(
                type,
    ...
    public List<ParquetField> sidecarFields() {
        return sidecarFields;
    }

    public List<BinaryString> sidecarKeys() {
        return sidecarKeys;
    }
}
