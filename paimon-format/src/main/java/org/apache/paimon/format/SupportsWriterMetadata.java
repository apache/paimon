...
/** Writer capability for formats that can attach key-value metadata before close. */
public interface SupportsWriterMetadata {

    /**
     * Adds file-level metadata to the writer.
     *
     * <p>The metadata values are raw bytes. Format implementations are responsible for converting
