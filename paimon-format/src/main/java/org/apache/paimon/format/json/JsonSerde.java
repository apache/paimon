...
public class JsonSerde {
    ...
    public static InternalRow convertJsonStringToRow(
            String line, RowType rowType, JsonOptions options) throws JsonProcessingException {
    ...
    private static Object convertJsonValue(JsonNode node, DataType dataType, JsonOptions options) {
    ...
    private static GenericMap convertJsonMap(
            JsonNode objectNode, MapType mapType, JsonOptions options) {
    ...
    private static GenericRow convertJsonRow(
            JsonNode objectNode, RowType rowType, JsonOptions options) {
        if (!objectNode.isObject()) {
            throw new RuntimeException("Expected object node but got: " + objectNode.getNodeType());
        }
