...
public class JsonFileFormat extends FileFormat {
    ...
    public static final ConfigOption<Boolean> JSON_TIMESTAMP_FORMAT_STANDARD =
            ConfigOptions.key("json.timestamp-format-standard")
                    .booleanType()
                    .defaultValue(true)
                    .withDescription("Whether to use ISO-8601 standard timestamp format");
    ...
    private static class JsonWriterFactory implements FormatWriterFactory {
        ...
        public FormatWriter create(PositionOutputStream out, String compression)
                throws IOException {
            return new JsonFormatWriter(out, rowType, options);
        }
    }
}
