    ...
    public void testWriteMetadata() throws IOException {
        ...
        byte[] arrowSchemaBytes =
                FormatMetadataUtils.buildArrowSchemaMetadata(
                        rowType, fieldMetadataByName, FormatMetadataUtils.ORC_FIELD_ID_KEY);
