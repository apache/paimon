...
/** Base implementation of Spark {@link TableCatalog} for table store. */
public abstract class SparkCatalogBase implements TableCatalog, SupportsNamespaces {
    ...
    protected org.apache.flink.table.store.file.catalog.Identifier toIdentifier(Identifier ident)
    ...
    protected org.apache.flink.table.store.table.Table load(Identifier ident)
