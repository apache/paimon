...
public class TestPrestoITCase {
    ...
    protected QueryRunner createQueryRunner() throws Exception {
        ...
        org.apache.paimon.presto.SimpleTableTestHelper testHelper1 = createTestHelper(tablePath1);
        ...
        org.apache.paimon.presto.SimpleTableTestHelper testHelper2 = createTestHelper(tablePath2);
    ...
    private static org.apache.paimon.presto.SimpleTableTestHelper createTestHelper(Path tablePath)
            throws Exception {
        RowType rowType =
                new RowType(
                        Arrays.asList(
        ...
        return new org.apache.paimon.presto.SimpleTableTestHelper(tablePath, rowType);
    }
