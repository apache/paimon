...
public final class Scalars {
    ...
    public static ScalarProtos.Scalar nullNull() {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(
                        ScalarProtos.ScalarValue.newBuilder()
    ...
    public static ScalarProtos.Scalar bool(boolean value) {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(ScalarProtos.ScalarValue.newBuilder().setBoolValue(value).build())
    ...
    public static ScalarProtos.Scalar int8(byte value) {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(ScalarProtos.ScalarValue.newBuilder().setInt64Value(value).build())
    ...
    public static ScalarProtos.Scalar float32(float value) {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(ScalarProtos.ScalarValue.newBuilder().setF32Value(value).build())
    ...
    public static ScalarProtos.Scalar float64(double value) {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(ScalarProtos.ScalarValue.newBuilder().setF64Value(value).build())
    ...
    public static ScalarProtos.Scalar string(String value) {
        return ScalarProtos.Scalar.newBuilder()
                .setValue(ScalarProtos.ScalarValue.newBuilder().setStringValue(value).build())
