    ...
    withTempDir {
      checkpointDir =>
        ...
        try {
          ...
          assertEquals(2, query.recentProgress.count(_.numInputRows != 0))
          assertEquals(
    ...
    withTempDir {
      checkpointDir =>
        ...
        try {
          ...
          assertEquals(1, query.recentProgress.count(_.numInputRows != 0))
          assertEquals(
    ...
    withTempDir {
      checkpointDir =>
        ...
        try {
          ...
          query.processAllAvailable()
          assertEquals(1, query.recentProgress.count(_.numInputRows != 0))
          assertEquals(3L, query.lastProgress.numInputRows)
          ...
          assertEquals(3, query.recentProgress.count(_.numInputRows != 0))
          assertEquals(16L, query.recentProgress.map(_.numInputRows).sum)
        } finally {
          query.stop()
        }
    }
