    ...
    failAfter(streamingTimeout) {
      withTempDir {
        checkpointDir =>
          ...
          val inputData = SparkShimLoader.shim.createMemoryStream[(Int, Int, Int)]
          val stream = inputData
            .toDS()
            .toDF("p", "a", "b")
            .writeStream
    ...
    failAfter(streamingTimeout) {
      withTempDir {
        checkpointDir =>
          ...
          val inputData = SparkShimLoader.shim.createMemoryStream[(Int, Int, String)]
          val stream = inputData
            .toDS()
            .toDF("a", "b", "c")
            .writeStream
    ...
    failAfter(streamingTimeout) {
      withTempDir {
        checkpointDir =>
          ...
          val inputData = SparkShimLoader.shim.createMemoryStream[(Int, Int, String, Int)]
          val stream = inputData
            .toDS()
            .toDF("a", "b", "c", "pt")
            .writeStream
