...
public class PaimonInternalRow extends org.apache.spark.sql.catalyst.InternalRow {

    private final RowType rowType;

    private InternalRow row;

    public PaimonInternalRow(RowType rowType) {
        this.rowType = rowType;
    }

    public PaimonInternalRow replace(InternalRow row) {
        this.row = row;
        return this;
    }
    ...
    public org.apache.spark.sql.catalyst.InternalRow copy() {
        return new PaimonInternalRow(rowType).replace(copyInternalRow(row, rowType));
    }
    ...
    public static org.apache.spark.sql.catalyst.InternalRow fromPaimon(
        ...
        return new PaimonInternalRow(rowType).replace(row);
    }
    ...
    private static ArrayData fromPaimonArrayElementType(InternalArray array, DataType elementType) {
        return new PaimonArrayData(elementType).replace(array);
    }
