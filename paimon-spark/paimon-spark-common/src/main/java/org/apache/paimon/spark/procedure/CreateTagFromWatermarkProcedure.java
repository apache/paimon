...
/** The procedure supports creating tags from a snapshot's watermark. */
public class CreateTagFromWatermarkProcedure extends BaseProcedure {
    ...
    protected CreateTagFromWatermarkProcedure(TableCatalog tableCatalog) {
        super(tableCatalog);
    }
    ...
    public InternalRow[] call(InternalRow args) {
        ...
        return modifyPaimonTable(
                ...
                table -> {
                    ...
                    // Fall back to the earliest tag whose watermark already covers the target,
                    // mirroring the Flink create_tag_from_watermark procedure.
