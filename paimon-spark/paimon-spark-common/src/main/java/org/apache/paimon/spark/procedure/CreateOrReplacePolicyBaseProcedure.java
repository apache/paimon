...
/** Shared implementation for creating or replacing a table data policy. */
abstract class CreateOrReplacePolicyBaseProcedure extends BasePolicyProcedure {
    ...
    protected CreateOrReplacePolicyBaseProcedure(TableCatalog tableCatalog) {
        super(tableCatalog);
    }
    ...
    protected abstract void writePolicy(DataPolicy policy);
}
