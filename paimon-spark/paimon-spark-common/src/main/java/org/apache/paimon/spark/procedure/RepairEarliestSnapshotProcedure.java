...
public class RepairEarliestSnapshotProcedure extends BaseProcedure {
    ...
    private static final StructType OUTPUT_TYPE =
            new StructType(
                    new StructField[] {
                        new StructField(
                                "previous_earliest_snapshot_id", LongType, false, Metadata.empty()),
                        new StructField(
                                "current_earliest_snapshot_id", LongType, false, Metadata.empty())
                    });
    ...
    public InternalRow[] call(InternalRow args) {
        ...
        return modifyPaimonTable(
                ...
                table -> {
                    ...
                    return new InternalRow[] {newInternalRow(previous, snapshotId)};
                });
    }
