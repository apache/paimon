...
public class PaimonCatalog extends BaseCatalog {
    ...
    @Override
    public PaimonTable loadTable(Identifier ident) throws NoSuchTableException {
        try {
            return new PaimonTable(load(ident));
     ...
     */
    public PaimonTable loadTable(Identifier ident, String version) throws NoSuchTableException {
        ...
        return new PaimonTable(table.copy(dynamicOptions.toMap()));
    }
     ...
     */
    public PaimonTable loadTable(Identifier ident, long timestamp) throws NoSuchTableException {
        Table table = loadPaimonTable(ident);
        ...
        return new PaimonTable(table.copy(option.toMap()));
    }
