...
import static org.apache.paimon.spark.PaimonInternalRow.fromPaimon;
import static org.apache.paimon.utils.InternalRowUtils.copyArray;

/** Spark {@link ArrayData} to wrap Paimon {@link InternalArray}. */
public class PaimonArrayData extends ArrayData {

    private final DataType elementType;

    private InternalArray array;

    public PaimonArrayData(DataType elementType) {
        this.elementType = elementType;
    }

    public PaimonArrayData replace(InternalArray array) {
        this.array = array;
        return this;
    }
    ...
    public ArrayData copy() {
        return new PaimonArrayData(elementType).replace(copyArray(array, elementType));
    }
