...
class PaimonDataSource
  extends DataSourceRegister
  with SessionConfigSupport
  with CreatableRelationProvider
  with StreamSinkProvider {

  override def shortName(): String = PaimonDataSource.NAME

  override def keyPrefix(): String = PaimonDataSource.NAME
  ...
  override def getTable(
    ...
    new PaimonTable(loadTable(properties))
  }
  ...
  override def createRelation(
    ...
    PaimonDataSource.toBaseRelation(table, sqlContext)
  }
