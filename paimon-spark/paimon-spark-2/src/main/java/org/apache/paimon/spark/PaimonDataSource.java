...
public class PaimonDataSource implements DataSourceRegister, ReadSupport, SessionConfigSupport {
    ...
    public DataSourceReader createReader(DataSourceOptions options) {
        ...
        return new PaimonDataSourceReader(FileStoreTableFactory.create(catalogContext));
    }
