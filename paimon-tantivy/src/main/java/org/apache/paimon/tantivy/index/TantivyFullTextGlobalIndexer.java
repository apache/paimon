...
public class TantivyFullTextGlobalIndexer implements GlobalIndexer {
    ...
    public TantivyFullTextGlobalIndexer(TantivyFullTextIndexOptions indexOptions) {
        this.indexOptions = indexOptions;
    }

    public TantivyFullTextGlobalIndexer() {
        this(TantivyFullTextIndexOptions.defaults());
    }
    ...
    public GlobalIndexReader createReader(
        ...
        return new TantivyFullTextGlobalIndexReader(fileReader, files, executor);
    }
}
