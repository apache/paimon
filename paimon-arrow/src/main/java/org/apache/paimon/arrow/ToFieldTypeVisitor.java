...
/** Convert Paimon type to {@link FieldType}. */
public class ToFieldTypeVisitor implements DataTypeVisitor<FieldType> {

    public static final ToFieldTypeVisitor INSTANCE = new ToFieldTypeVisitor();
    ...
    public FieldType visit(TimestampType timestampType) {
        return new FieldType(
                timestampType.isNullable(), Types.MinorType.TIMESTAMPNANO.getType(), null);
    }
    ...
    public FieldType visit(LocalZonedTimestampType localZonedTimestampType) {
        return new FieldType(
                ...
                Types.MinorType.TIMESTAMPNANO.getType(),
                null);
    }
