...
/**
 * Base interface of an internal data structure representing data of {@link VecType}.
 *
 ...
 */
@Public
public interface InternalVec extends InternalArray {
    ...
    static ElementGetter createElementGetter(DataType elementType) {
            ...
            default:
                String msg =
                        String.format(
                                ...
                                elementType.getTypeRoot().toString(), InternalVec.class.getName());
        ...
        return (vec, pos) -> {
            ...
            return elementGetter.getElementOrNull(vec, pos);
        };
    }
}
