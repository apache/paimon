...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = QuarterTransform.class, name = QuarterTransform.NAME),
    @JsonSubTypes.Type(value = IsoDayOfWeekTransform.class, name = IsoDayOfWeekTransform.NAME),
    @JsonSubTypes.Type(value = DayOfWeekTransform.class, name = DayOfWeekTransform.NAME),
    @JsonSubTypes.Type(value = WeekdayTransform.class, name = WeekdayTransform.NAME),
    @JsonSubTypes.Type(value = DayOfYearTransform.class, name = DayOfYearTransform.NAME),
    @JsonSubTypes.Type(value = WeekTransform.class, name = WeekTransform.NAME),
    @JsonSubTypes.Type(value = YearOfWeekTransform.class, name = YearOfWeekTransform.NAME),
    ...
    @JsonSubTypes.Type(value = BitLengthTransform.class, name = BitLengthTransform.NAME),
    @JsonSubTypes.Type(value = TranslateTransform.class, name = TranslateTransform.NAME),
    @JsonSubTypes.Type(value = OverlayTransform.class, name = OverlayTransform.NAME),
    @JsonSubTypes.Type(value = PadTransform.class, name = PadTransform.NAME),
    @JsonSubTypes.Type(value = DateAddTransform.class, name = DateAddTransform.NAME),
    @JsonSubTypes.Type(value = DateDiffTransform.class, name = DateDiffTransform.NAME),
    @JsonSubTypes.Type(value = DateTruncTransform.class, name = DateTruncTransform.NAME),
