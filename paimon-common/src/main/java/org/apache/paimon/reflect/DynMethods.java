...
package org.apache.paimon.reflect;

import org.apache.paimon.utils.Preconditions;

import org.apache.paimon.shade.guava30.com.google.common.base.Throwables;
...
public class DynMethods {
     ...
     *
     * <p>Allows callers to invoke the wrapped method with all Exceptions wrapped by
    ...
    public static class UnboundMethod {
        ...
        public String toString() {
            return "DynMethods.UnboundMethod(name="
                    + name
                    + " method="
                    + method.toGenericString()
                    + ")";
    ...
    public static class Builder {
        ...
        public Builder impl(Class<?> targetClass, String methodName, Class<?>... argClasses) {
            ...
            try {
                this.method =
                        new UnboundMethod(targetClass.getMethod(methodName, argClasses), name);
        ...
        public Builder ctorImpl(Class<?> targetClass, Class<?>... argClasses) {
            ...
            try {
                this.method =
                        new DynConstructors.Builder().impl(targetClass, argClasses).buildChecked();
            } catch (NoSuchMethodException e) {
                // not the right implementation
            }
            return this;
        ...
        public Builder ctorImpl(String className, Class<?>... argClasses) {
            ...
            try {
                this.method =
                        new DynConstructors.Builder().impl(className, argClasses).buildChecked();
            } catch (NoSuchMethodException e) {
                // not the right implementation
            }
            return this;
        ...
        /**
         * Returns the first valid implementation as a UnboundMethod or throws a RuntimeError if
         * there is none.
         *
        ...
        /**
         * Returns the first valid implementation as a BoundMethod or throws a RuntimeError if there
         * is none.
         *
         * @param receiver an Object to receive the method invocation
        ...
        /**
         * Returns the first valid implementation as a BoundMethod or throws a NoSuchMethodException
         * if there is none.
         *
         * @param receiver an Object to receive the method invocation
         * @return a {@link BoundMethod} with a valid implementation and receiver
