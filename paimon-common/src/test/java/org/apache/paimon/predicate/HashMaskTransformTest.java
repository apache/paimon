...
class HashMaskTransformTest {

    @Test
    void testNull() {
        HashMaskTransform transform =
                new HashMaskTransform(new FieldRef(0, "f0", DataTypes.STRING()));
    ...
    void testSha256HexLower() {
        HashMaskTransform transform =
                new HashMaskTransform(new FieldRef(0, "f0", DataTypes.STRING()), "sha256", null);
