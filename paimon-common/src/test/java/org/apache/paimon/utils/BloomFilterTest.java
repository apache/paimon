...
public class BloomFilterTest {
    ...
    public void testOneSegmentBuilder() {
        ...
        for (int input : inputs) {
            assertThat(builder.testHash(Integer.hashCode(input))).isTrue();
        }
    }
    ...
    public void testBloomNumBits() {
        ...
        assertThat(BloomFilter.optimalNumOfBits(300000000, 0.05)).isEqualTo(1870567268);
        assertThat(BloomFilter.optimalNumOfBits(300000000, 0.1)).isEqualTo(1437758756);
        assertThat(BloomFilter.optimalNumOfBits(300000000, 0.5)).isEqualTo(432808512);
        assertThat(BloomFilter.optimalNumOfBits(3000000000L, 0.8)).isEqualTo(1393332198);
        assertThat(BloomFilter.optimalNumOfBits(3000000000L, 0.9)).isEqualTo(657882327);
        assertThat(BloomFilter.optimalNumOfBits(3000000000L, 1)).isEqualTo(0);
    }
