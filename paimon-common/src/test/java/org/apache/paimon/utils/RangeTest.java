...
public class RangeTest {
    ...
    public void testUnion() {
        ...
        Range range2 = new Range(21, 30);
        Range actualUnion = Range.union(range1, range2);
    ...
    @Test
    public void testSortAndMergeOverlapEmpty() {
        List<Range> result = Range.sortAndMergeOverlap(Collections.emptyList());

        Assertions.assertThat(result).isEmpty();
    }

    @Test
    public void testSortAndMergeOverlapNull() {
        List<Range> result = Range.sortAndMergeOverlap(null);
    ...
    public void testAndComplex() {
        // Complex scenario with multiple ranges
        // left=[0,5],[10,15],[20,25],[30,35]
        // right=[3,12],[18,28],[32,40]
        // -> [3,5],[10,12],[20,25],[32,35]
        List<Range> left =
                Arrays.asList(
