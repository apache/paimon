...
public class VectorMappingUtilsTest {
    ...
    public void testCreateIndexMappedVectors() {
        ...
        for (int i = 0; i < mapping.length; i++) {
            assertThat(newColumnVectors[i]).isEqualTo(columnVectors[mapping[i]]);
        }
    }
    ...
    public void testForType() {
        ...
        assertThat(newColumnVectors[0]).isInstanceOf(IntColumnVector.class);
        ...
        assertThat(newColumnVectors[4]).isInstanceOf(BytesColumnVector.class);
        assertThat(((BytesColumnVector) newColumnVectors[4]).getBytes(0).data)
        ...
        assertThat(newColumnVectors[8]).isInstanceOf(BytesColumnVector.class);
        assertThat(((BytesColumnVector) newColumnVectors[8]).getBytes(0).data)
        ...
        assertThat(newColumnVectors[11]).isInstanceOf(IntColumnVector.class);
        assertThat(((IntColumnVector) newColumnVectors[11]).getInt(0)).isEqualTo(10);
