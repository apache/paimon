...
public class ReflectionUtilsTest {
    ...
    public void testSetPrivateFieldValueOnDeclaringClass() throws Exception {
        ...
        assertThat((String) ReflectionUtils.getPrivateFieldValue(child, "ownField"))
                .isEqualTo("new-value");
    }
    ...
    public void testSetPrivateFieldValueWalksSuperclass() throws Exception {
        Child child = new Child();
        ReflectionUtils.setPrivateFieldValue(child, "parentField", "from-parent");
        assertThat((String) ReflectionUtils.getPrivateFieldValue(child, "parentField"))
