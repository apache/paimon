...
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_2.3.jar
...
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_2.2.jar
...
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_2.1.jar
...
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.3.jar

mvn clean install -Dcheckstyle.skip=true -Dgpg.skip -DskipTests -Pflink-1.14 -Phive-2.2 -f flink-table-store-hive
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.2.jar

mvn clean install -Dcheckstyle.skip=true -Dgpg.skip -DskipTests -Pflink-1.14 -Phive-2.1 -f flink-table-store-hive
cp flink-table-store-hive/flink-table-store-hive-connector/target/flink-table-store-hive-catalog-${RELEASE_VERSION}.jar ${RELEASE_DIR}/flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.1.jar
...
gpg --armor --detach-sig "flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.3.jar"
gpg --armor --detach-sig "flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.2.jar"
gpg --armor --detach-sig "flink-table-store-hive-catalog-${RELEASE_VERSION}_1.14_2.1.jar"
...
$SHASUM "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.3.jar" > "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.3.jar.sha512"
$SHASUM "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.2.jar" > "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.2.jar.sha512"
$SHASUM "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.1.jar" > "flink-table-store-hive-connector-${RELEASE_VERSION}_1.14_2.1.jar.sha512"
