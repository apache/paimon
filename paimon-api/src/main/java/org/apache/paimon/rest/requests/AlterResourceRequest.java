...
/** Request for altering resource. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class AlterResourceRequest implements RESTRequest {
    ...
    @JsonCreator
    public AlterResourceRequest(@JsonProperty(FIELD_CHANGES) List<ResourceChange> changes) {
