...
public class ListResourceDetailsResponse implements PagedResponse<GetResourceResponse> {
    ...
    private final List<GetResourceResponse> resources;

    @JsonProperty(FIELD_NEXT_PAGE_TOKEN)
    private final String nextPageToken;

    public ListResourceDetailsResponse(
            @JsonProperty(FIELD_RESOURCES) List<GetResourceResponse> resources) {
        this(resources, null);
    }
    ...
    @Override
    public List<GetResourceResponse> data() {
        return getResources();
    }
}
