...
@Experimental
public class DatabaseReferenceResponse implements RESTResponse {
    ...
    public DatabaseReferenceResponse(@JsonProperty(FIELD_REFERENCE) DatabaseReference reference) {
