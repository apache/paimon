...
/** Response for listing resources globally. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ListResourcesGloballyResponse implements PagedResponse<Identifier> {
    ...
    @JsonCreator
    public ListResourcesGloballyResponse(
            @JsonProperty(FIELD_RESOURCES) List<Identifier> resources,
    ...
    public List<Identifier> resources() {
