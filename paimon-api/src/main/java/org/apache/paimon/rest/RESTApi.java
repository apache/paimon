...
import org.apache.paimon.rest.requests.ListPermissionAssignmentsRequest;
...
import org.apache.paimon.rest.requests.ListTablePoliciesRequest;
...
public class RESTApi {
    ...
    public void dropDatabase(String name) {
        client.delete(resourcePaths.database(name), DropDatabaseRequest.API_NAME, restAuthFunction);
    }
        ...
        ListTableDetailsResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(
                                ...
                                Pair.of(TABLE_NAME_PATTERN, tableNamePattern),
                                Pair.of(TABLE_TYPE, tableType)),
                        ListTableDetailsRequest.API_NAME,
        ...
        ListTablesGloballyResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(
                                ...
                                Pair.of(DATABASE_NAME_PATTERN, databaseNamePattern),
                                Pair.of(TABLE_NAME_PATTERN, tableNamePattern)),
                        ListTablesGloballyRequest.API_NAME,
    ...
    public TableSnapshot loadSnapshot(Identifier identifier) {
        GetTableSnapshotResponse response =
                client.get(
                        ...
                        GetTableSnapshotRequest.API_NAME,
    ...
    public Snapshot loadSnapshot(Identifier identifier, String version) {
        GetVersionSnapshotResponse response =
                client.get(
                        ...
                        GetVersionSnapshotRequest.API_NAME,
    ...
    public GetSemanticViewResponse getSemanticView(Identifier identifier) {
        ...
        return client.get(
                resourcePaths.semanticView(
                        identifier.getDatabaseName(), identifier.getObjectName()),
                GetSemanticViewRequest.API_NAME,
                GetSemanticViewResponse.class,
                restAuthFunction);
    }
    ...
    public PagedList<String> listSemanticViewsPaged(
        ...
        ListSemanticViewsResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(maxResults, pageToken),
                        ListSemanticViewsRequest.API_NAME,
    ...
    public void deleteSemanticView(Identifier identifier) {
        ...
        client.delete(
                resourcePaths.semanticView(
                        identifier.getDatabaseName(), identifier.getObjectName()),
                DeleteSemanticViewRequest.API_NAME,
                restAuthFunction);
    }
    ...
    public ListPermissionsResponse listPermissions(ListPermissionsRequest request) {
        ...
        return client.get(
                ...
                queryParams,
                ListPermissionAssignmentsRequest.API_NAME,
    ...
    public ListPoliciesResponse listPolicies(ListPoliciesRequest request) {
        ...
        return client.get(
                ...
                queryParams,
                ListTablePoliciesRequest.API_NAME,
                ...
                queryParams ->
                        client.get(
                                resourcePaths.partitions(
                                        identifier.getDatabaseName(), identifier.getObjectName()),
                                queryParams,
                                ListPartitionsRequest.API_NAME,
        ...
        ListFunctionDetailsResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(
                                ...
                                pageToken,
                                Pair.of(FUNCTION_NAME_PATTERN, functionNamePattern)),
                        ListFunctionDetailsRequest.API_NAME,
        ...
        ListFunctionsGloballyResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(
                                ...
                                Pair.of(DATABASE_NAME_PATTERN, databaseNamePattern),
                                Pair.of(FUNCTION_NAME_PATTERN, functionNamePattern)),
                        ListFunctionsGloballyRequest.API_NAME,
    ...
    public PagedList<GetViewResponse> listViewDetailsPaged(
        ...
        ListViewDetailsResponse response =
                client.get(
                        ...
                        buildPagedQueryParams(
                                maxResults, pageToken, Pair.of(VIEW_NAME_PATTERN, viewNamePattern)),
                        ListViewDetailsRequest.API_NAME,
    ...
    public PagedList<Identifier> listViewsPagedGlobally(
        ...
        ListViewsGloballyResponse response =
                client.get(
                        ...
                        ListViewsGloballyRequest.API_NAME,
