...
public interface DLFRequestSigner {
    ...
    /**
     * Generate signature headers for a request whose method and path the signer may need; by
     * default only the body is used, as in {@link #signHeaders(String, Instant, String, String)}.
     */
