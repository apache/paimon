...
function pytest_check() {
    ...
    # 3.6 and 3.7 run the minimal core subset: ray/lance/daft/pypaimon_rust/mosaic
    # have no wheels there, and the full suite imports them directly at collection time.
