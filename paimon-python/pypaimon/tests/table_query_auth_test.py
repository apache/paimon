...
class TestTableNoPermissionException(unittest.TestCase):
    ...
    def test_message_format(self):
        exc = TableNoPermissionException("db.table", Exception("forbidden"))
        self.assertIn("db.table", str(exc))
        self.assertIn("has no permission", str(exc))
        self.assertEqual(exc.identifier, "db.table")

    def test_without_cause(self):
        exc = TableNoPermissionException("db.table")
        self.assertIn("db.table", str(exc))
