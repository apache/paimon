...
from .rest_catalog_server import RESTCatalogServer, AUTHORIZATION_HEADER_KEY
from ..api import RESTApi, RESTCatalogOptions
...
from ..pynative.catalog.catalog_context import CatalogContext
from ..pynative.catalog.table_metadata import TableMetadata
from ..pynative.common.core_options import CoreOptions
from ..pynative.common.identifier import Identifier
from ..pynative.rest.rest_catalog import RESTCatalog
...
class ApiTestCase(unittest.TestCase):
    ...
    def test_api(self):
        # Start server
        server, data_path = self.server_start()
        try:
    ...
    def test_rest_catalog(self):
        ...
        try:
            ...
            rest_catalog = RESTCatalog(CatalogContext.create_from_options(options))
            self.assertSetEqual(set(rest_catalog.list_databases()), {*test_databases})
            self.assertEqual(rest_catalog.get_database('default'), test_databases.get('default').to_database())
    ...
    def test_ecs_loader_token(self):
        ...
        try:
            ...
            options = {
                RESTCatalogOptions.DLF_TOKEN_LOADER: 'ecs',
                RESTCatalogOptions.DLF_TOKEN_ECS_METADATA_URL: ecs_metadata_url
            }
            ...
            options_with_role = {
                RESTCatalogOptions.DLF_TOKEN_LOADER: 'ecs',
                RESTCatalogOptions.DLF_TOKEN_ECS_METADATA_URL: ecs_metadata_url,
                RESTCatalogOptions.DLF_TOKEN_ECS_ROLE_NAME: role_name,
            }
