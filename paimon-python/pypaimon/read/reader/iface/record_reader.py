...
class RecordReader(Generic[T], ABC):
    ...
    def _refresh_blob_view_lookup(self, reader) -> None:
        ...
        # wrappers have already copied metadata in __init__. Descriptor indices
        # are known at construction and must not be overwritten: the inner
        # reader may still hold None or unprojected coordinates.
