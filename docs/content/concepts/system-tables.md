...
/*
+-----------+--------------+-------------------+------------+-------------+---------------------+---------------------+------------+------------+---------+-------+
| partition | record_count | file_size_in_bytes| file_count | num_buckets | last_update_time    | created_at          | created_by | updated_by | options | done  |
+-----------+--------------+-------------------+------------+-------------+---------------------+---------------------+------------+------------+---------+-------+
| {1}       |            1 |               645 |          1 |           1 | 2024-06-24 10:25:57 | 2024-06-24 10:20:00 | admin      | test_user  | {}      | false |
+-----------+--------------+-------------------+------------+-------------+---------------------+---------------------+------------+------------+---------+-------+
*/
```
