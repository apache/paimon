...
<table class="configuration table table-bordered">
    ...
    <tbody>
        <tr>
            <td><h5>watermark-generation.emit-per-records</h5></td>
            <td style="word-wrap: break-word;">100</td>
            <td>Integer</td>
            <td>How many records to emit watermark once, this ensures that split can emit a valid watermark before it ends.</td>
        </tr>
        <tr>
            <td><h5>watermark-alignment.group</h5></td>
            <td style="word-wrap: break-word;">(none)</td>
            <td>String</td>
            <td>A group of sources to align watermarks.</td>
        </tr>
        <tr>
            <td><h5>watermark-alignment.max-drift</h5></td>
            <td style="word-wrap: break-word;">(none)</td>
            <td>Duration</td>
            <td>Maximal drift to align watermarks, before we pause consuming from the source/task/partition.</td>
        </tr>
        <tr>
            <td><h5>watermark-alignment.update-interval</h5></td>
