...
# For branch support
manager_branch = ConsumerManager(file_io, table.location(), branch_name='my_branch')
```
...
# Custom branch
manager_branch = ConsumerManager(file_io, table.location(), branch_name='feature_branch')
