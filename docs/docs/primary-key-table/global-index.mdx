...
For scalar and vector indexes, partial coverage affects acceleration, not correctness:
...
- Primary-key Full Text supports only FAST search mode and excludes uncovered files until
