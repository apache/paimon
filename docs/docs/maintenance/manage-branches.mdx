...
__Note:__ The `Delete Branches` operation only deletes the metadata file. If you want to clear the data written during the branch, see [Remove Orphan Files](./manage-snapshots#remove-orphan-files).
