...
2. Append tables in [Data Evolution](../multimodal-table/data-evolution) mode also support this feature when row tracking and deletion vectors are enabled and bucket is `-1`.
