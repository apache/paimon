...
In Paimon, clustering is a feature that allows you to cluster data in your [Append Table](../append-table/)
...
tasks when reading the data, as it enables faster and more targeted data retrieval. This feature is only supported for [Append Table](../append-table/)(bucket = -1)
