...
### VARIANT DOUBLE Updates

Transform existing DOUBLE paths without decoding unrelated fields:
...
The paths must exist and contain DOUBLE values. The metadata is unchanged.
