...
Video imports keep each Episode in one normal file while camera sidecars roll
independently at Episode boundaries; their target table must be unpartitioned
and bucket-unaware.
