...
After splitting, one dedicated file can cover multiple normal-file row-ID ranges.
All Java and PyPaimon readers must support this layout before enabling the option.
Disabling the option later does not undo this layout change.
