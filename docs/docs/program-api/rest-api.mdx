...
| Tables within a database branch/tag | [Reference-scoped table usage](../concepts/rest/database-versioning#java-table-usage) |
...
[Java catalog access](../concepts/rest/management-api#java-catalog-access).
...
[the label wire contract](../concepts/rest/management-api#entity-labels).
...
See [Semantic Views](../concepts/rest/semantic-views.md) for Java examples, upsert behavior,
