...
1. Only [primary key table]({{< ref "概念/primary-key-table" >}}) supports this feature.
2. [MergeEngine]({{< ref "概念/primary-key-table#merge-engines" >}}) needs to be [deduplicate]({{< ref "概念/primary-key-table#deduplicate" >}}) or [partial-update]({{< ref "概念/primary-key-table#partial-update" >}}) to support this feature.
{{< /hint >}}
...
2. If the table has primary keys, [MergeEngine]({{< ref "概念/primary-key-table#merge-engines" >}}) needs to be [deduplicate]({{< ref "概念/primary-key-table#deduplicate" >}}) to support this feature.
   {{< /hint >}}
