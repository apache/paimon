...
public class FlinkCatalog extends AbstractCatalog {
    ...
    public final List<CatalogPartitionSpec> listPartitions(ObjectPath tablePath)
        ...
        Map<String, DataType> partitionKeysType = new HashMap<>();
        Map<String, Integer> partitionKeysPosition = new HashMap<>();
        for (String partitionKey : partitionKeys) {
            int keyIndex = table.rowType().getFieldIndex(partitionKey);
            DataType keyType = table.rowType().getTypeAt(keyIndex);

            partitionKeysPosition.put(partitionKey, keyIndex);
            partitionKeysType.put(partitionKey, keyType);
        }
        Set<CatalogPartitionSpec> partitions = new HashSet<>();
