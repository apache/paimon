...
/**
 * An interface for {@link PulsarDeserializationSchema dynamicPulsarSerializationSchema} that need
 ...
 */
@PublicEvolving
public interface PulsarContextAware<T> extends ResultTypeQueryable<byte[]> {
