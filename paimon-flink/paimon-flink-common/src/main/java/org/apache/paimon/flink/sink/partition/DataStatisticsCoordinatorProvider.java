...
class DataStatisticsCoordinatorProvider extends RecreateOnResetOperatorCoordinator.Provider {

    private static final long serialVersionUID = 1L;

    private final String operatorName;

    DataStatisticsCoordinatorProvider(String operatorName, OperatorID operatorID) {
        super(operatorID);
