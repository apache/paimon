...
public class CommitterCoordinatedFactory<CommitT, GlobalCommitT>
    ...
    RowDataStoreWriteOperator.Factory writeFactory;
    private Committer.Factory<CommitT, GlobalCommitT> committerFactory;
    ...
    public final <T extends StreamOperator<Committable>> T createStreamOperator(
        ...
        operator.setFileInfoSender(
                new CoordinatedFileInfoSender(
                        gateway, operatorID, this.streamingCheckpointEnabled));
        return (T) operator;
    }
