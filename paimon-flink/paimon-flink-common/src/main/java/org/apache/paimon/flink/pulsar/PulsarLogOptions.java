...
public class PulsarLogOptions {
    ...
    public static final String PULSAR_KEY_UPPER_SPLIT = "-";
    ...
    public static final ConfigOption<String> SEND_TIMEOUT_MS =
            ConfigOptions.key(PRODUCER_CONFIG_PREFIX + "send-timeout-ms")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Specify the subscription name for Paimon consumer.");

    public static final ConfigOption<String> TRANSACTION_TIMEOUT =
            ConfigOptions.key(CLIENT_CONFIG_PREFIX + "transaction-timeout")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Specify the subscription name for Paimon consumer.");

    public static final ConfigOption<String> MAX_BLOCK_TIME_MS =
            ConfigOptions.key(CLIENT_CONFIG_PREFIX + "max-block-time-ms")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Specify the subscription name for Paimon consumer.");
}
