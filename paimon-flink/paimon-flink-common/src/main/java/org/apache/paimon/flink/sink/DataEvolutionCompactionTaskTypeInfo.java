...
public class DataEvolutionCompactionTaskTypeInfo extends TypeInformation<DataEvolutionCompactTask> {
     ...
     */
    public TypeSerializer<DataEvolutionCompactTask> createSerializer(SerializerConfig config) {
     ...
     */
    public TypeSerializer<DataEvolutionCompactTask> createSerializer(ExecutionConfig config) {
        // we don't need copy for task
        return new NoneCopyVersionedSerializerTypeSerializerProxy<DataEvolutionCompactTask>(
                () ->
