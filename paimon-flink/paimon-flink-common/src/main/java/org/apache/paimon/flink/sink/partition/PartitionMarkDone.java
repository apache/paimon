...
import org.apache.paimon.CoreOptions.PartitionMarkDoneMode;
...
public class PartitionMarkDone implements PartitionListener {
    ...
    private final PartitionMarkDoneMode partitionMarkDoneMode;
    ...
    public static Optional<PartitionMarkDone> create(
        ...
        return Optional.of(
                new PartitionMarkDone(
                        ...
                        actions,
                        waitCompaction,
                        coreOptions.partitionMarkDoneMode()));
    }
    ...
    public PartitionMarkDone(
            ...
            List<PartitionMarkDoneAction> actions,
            boolean waitCompaction,
            PartitionMarkDoneMode partitionMarkDoneMode) {
        this.partitionComputer = partitionComputer;
        this.trigger = trigger;
        this.actions = actions;
        this.waitCompaction = waitCompaction;
        this.partitionMarkDoneMode = partitionMarkDoneMode;
    }

    @Override
    public void notifyCommittable(List<ManifestCommittable> committables) {
        if (partitionMarkDoneMode == PartitionMarkDoneMode.WATERMARK) {
    ...
    private void markDoneByWatermark(List<ManifestCommittable> committables) {
        ...
        markDone(trigger.donePartitions(endInput, latestWatermark.get()), actions);
    }

    @VisibleForTesting
    protected Tuple2<Map<BinaryRow, Long>, Boolean> extractPartitionWatermarks(
