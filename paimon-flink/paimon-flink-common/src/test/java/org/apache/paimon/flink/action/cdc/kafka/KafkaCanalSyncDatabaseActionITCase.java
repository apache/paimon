...
public class KafkaCanalSyncDatabaseActionITCase extends KafkaCanalActionITCaseBase {
    ...
    public void testSchemaEvolution() throws Exception {
        ...
        testSchemaEvolutionImpl(topics);
    }

    private void testSchemaEvolutionImpl(List<String> topics) throws Exception {
    ...
    @Test
    public void testSpecifiedOneTopic() {
        final String topic1 = "topic0";
    ...
    public void testTableAffix() throws Exception {
        ...
        testTableAffixImpl(topics);
    }

    private void testTableAffixImpl(List<String> topics) throws Exception {
