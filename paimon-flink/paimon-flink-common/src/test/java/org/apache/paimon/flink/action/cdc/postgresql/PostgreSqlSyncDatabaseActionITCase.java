...
public class PostgreSqlSyncDatabaseActionITCase extends PostgreSqlActionITCaseBase {
    ...
    @Test
    public void testSpecifiedPostgreSqlTable() {
        Map<String, String> postgreSqlConfig = getBasicPostgreSqlConfig();
        postgreSqlConfig.put("database-name", DATABASE_NAME);
        postgreSqlConfig.put("schema-name", SCHEMA_NAME);
        postgreSqlConfig.put("table-name", "my_table");
    ...
    public void testInvalidSchema() {
        Map<String, String> postgreSqlConfig = getBasicPostgreSqlConfig();
        postgreSqlConfig.put("database-name", DATABASE_NAME);
        postgreSqlConfig.put("schema-name", "invalid");
        ...
        assertThat(e)
                .hasMessage(
                        "No tables found in PostgreSQL schema invalid, or PostgreSQL schema does not exist.");
    }
