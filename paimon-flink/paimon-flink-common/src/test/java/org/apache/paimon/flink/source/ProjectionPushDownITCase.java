...
public class ProjectionPushDownITCase extends CatalogITCaseBase {
    ...
    public List<String> ddl() {
        return ImmutableList.of(
                "CREATE TABLE T ("
                        + "a INT, b ROW<b0 INT, b1 STRING>, c STRING, d ROW<d0 STRING, d1 BOOLEAN, d2 INT>) PARTITIONED BY (a);");
    }
    ...
    public void before() throws IOException {
        ...
        batchSql(
                "INSERT INTO T VALUES "
                        + "(1, ROW(10, 'value1'), '1', ROW('valued1', true, 10)), "
                        + "(1, ROW(20, 'value2'), '2', ROW('valued2', false, 20)), "
                        + "(2, ROW(30, 'value3'), '3', ROW('valued3', true, 30)), "
                        + "(3, ROW(30, 'value3'), '3', ROW('valued3', false, 30))");
    }
    ...
    @Test
    public void testMultipleNestedProjectionPushDown() {
