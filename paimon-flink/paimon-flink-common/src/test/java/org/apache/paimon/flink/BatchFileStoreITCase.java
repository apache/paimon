...
public class BatchFileStoreITCase extends CatalogITCaseBase {
    ...
    public void testScanWithSpecifiedPartitionsWithMaxPt() {
        ...
        String query =
                "SELECT Q.id, P.v FROM Q INNER JOIN P /*+ OPTIONS('scan.partitions' = 'max_pt()') */ ON Q.id = P.id ORDER BY Q.id, P.v";
    ...
    public void testScanWithSpecifiedPartitionsWithMaxTwoPt() {
        ...
        sql("INSERT INTO Q VALUES (1), (2), (3)");
        String query =
                "SELECT Q.id, P.v FROM Q INNER JOIN P /*+ OPTIONS('scan.partitions' = 'max_two_pt()') */ ON Q.id = P.id ORDER BY Q.id, P.v";
    ...
    public void testScanWithSpecifiedPartitionsWithLevelMaxPt() throws Exception {
        ...
        String query =
                "SELECT Q.id, P.v FROM Q INNER JOIN P /*+ OPTIONS('scan.partitions' = 'pt1=max_pt(),pt2=max_pt()') */ ON Q.id = P.id ORDER BY Q.id, P.v";
