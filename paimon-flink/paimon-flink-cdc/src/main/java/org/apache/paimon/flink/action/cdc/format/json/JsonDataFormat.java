 ...
 * queue's record json deserialization class and parsing class {@link JsonRecordParser}.
 */
public class JsonDataFormat extends AbstractJsonDataFormat {

    @Override
    protected RecordParserFactory parser() {
        return JsonRecordParser::new;
    }
}
