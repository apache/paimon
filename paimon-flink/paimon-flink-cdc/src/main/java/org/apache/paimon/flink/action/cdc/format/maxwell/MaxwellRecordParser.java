...
/**
 * The {@code MaxwellRecordParser} class extends the abstract {@link JsonRecordParser} and is
 * designed to parse records from Maxwell's JSON change data capture (CDC) format. Maxwell is a CDC
 * solution for MySQL databases that captures row-level changes to database tables and outputs them
 * in JSON format. This parser extracts relevant information from the Maxwell-JSON format and
 ...
 */
public class MaxwellRecordParser extends JsonRecordParser {
