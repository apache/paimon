...
/** Factory to create {@link OracleSyncTableAction}. */
public class OracleSyncTableActionFactory extends SyncTableActionFactoryBase {

    public static final String IDENTIFIER = "oracle_sync_table";
    ...
    @Override
    public OracleSyncTableAction createAction() {
        return new OracleSyncTableAction(
                this.tablePath.f0,
                this.tablePath.f1,
                this.tablePath.f2,
                this.catalogConfig,
