...
public class PulsarKeyValueDeserializationSchema
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(PulsarKeyValueDeserializationSchema.class);
    ...
    public CdcSourceRecord deserialize(Message<byte[]> message) throws IOException {
    ...
    public void deserialize(Message<byte[]> message, Collector<CdcSourceRecord> collector)
            throws IOException {
        CdcSourceRecord sourceRecord = deserialize(message);
