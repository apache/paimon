 ...
 *
 * <p>In flink 1.19, the {@link FunctionUtils#openFunction} method parameters have changed, from
 * org.apache.flink.configuration.Configuration to {@link OpenContext}.
 */
public class RowDataStoreWriteOperator extends TableWriteOperator<InternalRow> {
    ...
    public void open() throws Exception {
        ...
        if (logSinkFunction != null) {
            FunctionUtils.openFunction(logSinkFunction, DefaultOpenContext.INSTANCE);
