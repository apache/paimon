...
public class ExpireChangelogsProcedure extends ProcedureBase {
    ...
    public String[] call(
        ...
        return call(procedureContext, tableId, retainMax, retainMin, olderThan, Integer.MAX_VALUE);
    }
                ...
                Duration.ofMillis(
                        System.currentTimeMillis()
                                - DateTimeUtils.parseTimestampData(
                                                olderThan, 3, TimeZone.getDefault())
                                        .getMillisecond()));
    ...
    public String[] call(ProcedureContext procedureContext, String tableId, boolean deleteAll)
            throws Catalog.TableNotExistException {
        ExpireChangelogImpl expireChangelogs =
                (ExpireChangelogImpl) table(tableId).newExpireChangelog();
