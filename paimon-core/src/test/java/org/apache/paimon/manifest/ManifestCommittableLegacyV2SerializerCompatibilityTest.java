...
public class ManifestCommittableLegacyV2SerializerCompatibilityTest
        extends ManifestCommittableSerializerCompatibilityTest {

    @Test
    public void testCompatibilityToLegacyVersion2() throws IOException {
        ...
        ManifestCommittableSerializer serializer = new ManifestCommittableLegacyV2Serializer();
        ...
        byte[] v2Bytes =
                IOUtils.readFully(
                        ManifestCommittableLegacyV2SerializerCompatibilityTest.class
                                .getClassLoader()
                                .getResourceAsStream(
                                        "compatibility/manifest-committable-legacy-v2"),
                        true);
