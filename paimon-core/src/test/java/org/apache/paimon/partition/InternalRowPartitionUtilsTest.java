...
/** Test class for {@link InternalRowPartitionUtils}. */
public class InternalRowPartitionUtilsTest {
    ...
    public void testCreateTriangularPredicate() {
        ...
        Predicate predicate =
                InternalRowPartitionUtils.createTriangularPredicate(
                        partitionValue,
                        partitionConverter,
    ...
    public void testCreateLinearPredicate() {
        ...
        PredicateBuilder builder = new PredicateBuilder(rowType);
        Predicate predicate =
                InternalRowPartitionUtils.createLinearPredicate(
                        partitionValue,
                        partitionConverter,
                        (Integer i, Object j) -> builder.equal(i, j));
        Assertions.assertTrue(predicate.test(partitionValue));
