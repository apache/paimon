...
public class SchemaMergingUtilsTest {
    ...
    public void testMergeTableSchemas() {
        ...
        TableSchema merged = SchemaMergingUtils.mergeSchemas(current, t, false, true);
    ...
    public void testMergeSchemas() {
        ...
        RowType r1 = (RowType) SchemaMergingUtils.merge(source, t1, highestFieldId, false, true);
        ...
        RowType r2 = SchemaMergingUtils.mergeSchemas(r1, t2, highestFieldId, false, true);
        assertThat(highestFieldId.get()).isEqualTo(4);
        ...
        RowType r3 = (RowType) SchemaMergingUtils.merge(r2, t3, highestFieldId, false, true);
        ...
        RowType r4 = SchemaMergingUtils.mergeSchemas(r3, t4, highestFieldId, false, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(r4, t5, highestFieldId, false, true))
        ...
        RowType r6 = SchemaMergingUtils.mergeSchemas(r4, t6, highestFieldId, false, true);
    ...
    public void testMergeArrayTypes() {
        ...
        ArrayType r1 =
                (ArrayType) SchemaMergingUtils.merge(source, t1, highestFieldId, false, true);
        ...
        ArrayType r2 =
                (ArrayType) SchemaMergingUtils.merge(source, t2, highestFieldId, false, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(source, t3, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // the value type of target's isn't same to the source's, but the source type can be cast to
        // the target type explicitly.
        ArrayType r3 = (ArrayType) SchemaMergingUtils.merge(source, t3, highestFieldId, true, true);
    ...
    public void testMergeMapTypes() {
        ...
        MapType r1 = (MapType) SchemaMergingUtils.merge(source, t1, highestFieldId, false, true);
        assertThat(r1.isNullable()).isTrue();
        ...
        MapType r2 = (MapType) SchemaMergingUtils.merge(source, t2, highestFieldId, false, true);
        ...
        // the value type of target's isn't same to the source's, but the source type can be cast to
        // the target type explicitly.
        MapType r3 = (MapType) SchemaMergingUtils.merge(source, t3, highestFieldId, true, true);
    ...
    public void testMergeMultisetTypes() {
        ...
        MultisetType r1 =
                (MultisetType) SchemaMergingUtils.merge(source, t1, highestFieldId, false, true);
        assertThat(r1.isNullable()).isFalse();
        assertThat(r1.getElementType() instanceof IntType).isTrue();
        ...
        MultisetType r2 =
                (MultisetType) SchemaMergingUtils.merge(source, t2, highestFieldId, false, true);
        assertThat(r2.isNullable()).isFalse();
        assertThat(r2.getElementType() instanceof BigIntType).isTrue();
        ...
        // the target type explicitly.
        MultisetType r3 =
                (MultisetType) SchemaMergingUtils.merge(source, t3, highestFieldId, true, true);
        assertThat(r3.isNullable()).isFalse();
        assertThat(r3.getElementType() instanceof SmallIntType).isTrue();
    }
    ...
    public void testMergeDecimalTypes() {
        ...
        DecimalType r1 =
                (DecimalType) SchemaMergingUtils.merge(s1, t1, highestFieldId, false, true);
        assertThat(r1.isNullable()).isTrue();
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s2, t2, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        DataType s3 = new DecimalType(false, 5, 2);
        DataType t3 = new DecimalType(7, 2);
        DecimalType r3 =
                (DecimalType) SchemaMergingUtils.merge(s3, t3, highestFieldId, false, true);
        assertThat(r3.isNullable()).isFalse();
        ...
        DecimalType r4 =
                (DecimalType) SchemaMergingUtils.merge(s4, t4, highestFieldId, false, true);
        ...
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dcmSource, iTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DecimalType -> Other Numeric Type with allowExplicitCast = true
        DataType res = SchemaMergingUtils.merge(dcmSource, iTarget, highestFieldId, true, true);
    ...
    public void testMergeTypesWithLength() {
        ...
        BinaryType r1 = (BinaryType) SchemaMergingUtils.merge(s1, t1, highestFieldId, false, true);
        ...
        BinaryType r2 = (BinaryType) SchemaMergingUtils.merge(s2, t2, highestFieldId, true, true);
        assertThat(r2.getLength()).isEqualTo(BinaryType.DEFAULT_LENGTH);
        // bigger length
        DataType t3 = new BinaryType(5);
        BinaryType r3 = (BinaryType) SchemaMergingUtils.merge(s2, t3, highestFieldId, false, true);
        ...
        VarCharType r4 =
                (VarCharType) SchemaMergingUtils.merge(s4, t4, highestFieldId, false, true);
        assertThat(r4.getLength()).isEqualTo(VarCharType.DEFAULT_LENGTH);

        DataType s5 = new VarCharType(2);
        DataType t5 = new VarCharType();
        // smaller length
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s5, t5, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // smaller length  with allowExplicitCast = true
        VarCharType r5 = (VarCharType) SchemaMergingUtils.merge(s5, t5, highestFieldId, true, true);
        assertThat(r5.getLength()).isEqualTo(VarCharType.DEFAULT_LENGTH);
        // bigger length
        DataType t6 = new VarCharType(5);
        VarCharType r6 =
                (VarCharType) SchemaMergingUtils.merge(s5, t6, highestFieldId, false, true);
        assertThat(r6.getLength()).isEqualTo(5);

        // CharType
        DataType s7 = new CharType();
        DataType t7 = new CharType(1);
        CharType r7 = (CharType) SchemaMergingUtils.merge(s7, t7, highestFieldId, false, true);
        assertThat(r7.getLength()).isEqualTo(CharType.DEFAULT_LENGTH);

        DataType s8 = new CharType(2);
        DataType t8 = new CharType();
        // smaller length
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s8, t8, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // smaller length  with allowExplicitCast = true
        CharType r8 = (CharType) SchemaMergingUtils.merge(s8, t8, highestFieldId, true, true);
        assertThat(r8.getLength()).isEqualTo(CharType.DEFAULT_LENGTH);
        // bigger length
        DataType t9 = new CharType(5);
        CharType r9 = (CharType) SchemaMergingUtils.merge(s8, t9, highestFieldId, false, true);
        ...
        VarBinaryType r10 =
                (VarBinaryType) SchemaMergingUtils.merge(s10, t10, highestFieldId, false, true);
        ...
        // smaller length
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s11, t11, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // smaller length  with allowExplicitCast = true
        VarBinaryType r11 =
                (VarBinaryType) SchemaMergingUtils.merge(s11, t11, highestFieldId, true, true);
        assertThat(r11.getLength()).isEqualTo(VarBinaryType.DEFAULT_LENGTH);
        // bigger length
        DataType t12 = new VarBinaryType(5);
        VarBinaryType r12 =
                (VarBinaryType) SchemaMergingUtils.merge(s11, t12, highestFieldId, false, true);
        ...
        VarCharType r13 =
                (VarCharType) SchemaMergingUtils.merge(s13, t13, highestFieldId, false, true);
        assertThat(r13.getLength()).isEqualTo(10);

        // VarCharType ->CharType
        DataType s14 = new VarCharType(10);
        DataType t14 = new CharType();
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s14, t14, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        CharType r14 = (CharType) SchemaMergingUtils.merge(s14, t14, highestFieldId, true, true);
        ...
        VarBinaryType r15 =
                (VarBinaryType) SchemaMergingUtils.merge(s15, t15, highestFieldId, false, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s16, t16, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        BinaryType r16 =
                (BinaryType) SchemaMergingUtils.merge(s16, t16, highestFieldId, true, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s17, t17, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        VarBinaryType r17 =
                (VarBinaryType) SchemaMergingUtils.merge(s17, t17, highestFieldId, true, true);
    ...
    public void testMergeTypesWithPrecision() {
        ...
        LocalZonedTimestampType r1 =
                (LocalZonedTimestampType)
                        SchemaMergingUtils.merge(s1, t1, highestFieldId, false, true);
        assertThat(r1.isNullable()).isTrue();
        ...
        LocalZonedTimestampType r2 =
                (LocalZonedTimestampType)
                        SchemaMergingUtils.merge(s1, t2, highestFieldId, false, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s3, t3, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        ...
        TimestampType r4 =
                (TimestampType) SchemaMergingUtils.merge(s4, t4, highestFieldId, false, true);
        ...
        TimestampType r5 =
                (TimestampType) SchemaMergingUtils.merge(s5, t5, highestFieldId, false, true);
        ...
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        s5, new TimestampType(3), highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        // higher precision
        DataType t6 = new TimestampType(9);
        TimestampType r6 =
                (TimestampType) SchemaMergingUtils.merge(s5, t6, highestFieldId, false, true);
        ...
        LocalZonedTimestampType r7 =
                (LocalZonedTimestampType)
                        SchemaMergingUtils.merge(s7, t7, highestFieldId, false, true);
        ...
        TimeType r8 = (TimeType) SchemaMergingUtils.merge(s8, t8, highestFieldId, false, true);
        assertThat(r8.getPrecision()).isEqualTo(TimestampType.DEFAULT_PRECISION);

        // TimeType.
        DataType s9 = new TimeType();
        DataType t9 = new TimeType();
        TimeType r9 = (TimeType) SchemaMergingUtils.merge(s9, t9, highestFieldId, false, true);
        ...
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        s10, new TimeType(3), highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        // higher precision
        DataType t10 = new TimeType(9);
        TimeType r10 = (TimeType) SchemaMergingUtils.merge(s9, t10, highestFieldId, false, true);
        ...
        LocalZonedTimestampType r11 =
                (LocalZonedTimestampType)
                        SchemaMergingUtils.merge(s11, t11, highestFieldId, true, true);
        ...
        assertThatThrownBy(() -> SchemaMergingUtils.merge(s12, t12, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        // TimeType -> TimestampType with allowExplicitCast = true
        TimestampType r12 =
                (TimestampType) SchemaMergingUtils.merge(s12, t12, highestFieldId, true, true);
    ...
    public void testMergePrimitiveTypes() {
        ...
        // BooleanType
        DataType btRes1 = SchemaMergingUtils.merge(bSource, bTarget, highestFieldId, false, true);
        assertThat(btRes1 instanceof BooleanType).isTrue();
        // BooleanType -> Numeric Type
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        bSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        // BooleanType -> Numeric Type with allowExplicitCast = true
        DataType btRes2 = SchemaMergingUtils.merge(bSource, tiTarget, highestFieldId, true, true);
        assertThat(btRes2 instanceof TinyIntType).isTrue();

        // TinyIntType
        DataType tiRes1 = SchemaMergingUtils.merge(tiSource, tiTarget, highestFieldId, false, true);
        assertThat(tiRes1 instanceof TinyIntType).isTrue();
        // TinyIntType -> SmallIntType
        DataType tiRes2 = SchemaMergingUtils.merge(tiSource, siTarget, highestFieldId, false, true);
        assertThat(tiRes2 instanceof SmallIntType).isTrue();
        // TinyIntType -> IntType
        DataType tiRes3 = SchemaMergingUtils.merge(tiSource, iTarget, highestFieldId, false, true);
        assertThat(tiRes3 instanceof IntType).isTrue();
        // TinyIntType -> BigIntType
        DataType tiRes4 = SchemaMergingUtils.merge(tiSource, biTarget, highestFieldId, false, true);
        assertThat(tiRes4 instanceof BigIntType).isTrue();
        // TinyIntType -> FloatType
        DataType tiRes5 = SchemaMergingUtils.merge(tiSource, fTarget, highestFieldId, false, true);
        assertThat(tiRes5 instanceof FloatType).isTrue();
        // TinyIntType -> DoubleType
        DataType tiRes6 = SchemaMergingUtils.merge(tiSource, dTarget, highestFieldId, false, true);
        assertThat(tiRes6 instanceof DoubleType).isTrue();
        // TinyIntType -> DecimalType
        DataType tiRes7 =
                SchemaMergingUtils.merge(tiSource, dcmTarget, highestFieldId, false, true);
        assertThat(tiRes7 instanceof DecimalType).isTrue();
        // TinyIntType -> BooleanType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        tiSource, bTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);

        // TinyIntType -> BooleanType with allowExplicitCast = true
        DataType tiRes8 = SchemaMergingUtils.merge(tiSource, bTarget, highestFieldId, true, true);
        assertThat(tiRes8 instanceof BooleanType).isTrue();

        // SmallIntType
        DataType siRes1 = SchemaMergingUtils.merge(siSource, siTarget, highestFieldId, false, true);
        assertThat(siRes1 instanceof SmallIntType).isTrue();
        // SmallIntType -> TinyIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        siSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // SmallIntType -> TinyIntType with allowExplicitCast = true
        DataType siRes2 = SchemaMergingUtils.merge(siSource, tiTarget, highestFieldId, true, true);
        assertThat(siRes2 instanceof TinyIntType).isTrue();
        // SmallIntType -> IntType
        DataType siRes3 = SchemaMergingUtils.merge(siSource, iTarget, highestFieldId, false, true);
        assertThat(siRes3 instanceof IntType).isTrue();
        // SmallIntType -> BigIntType
        DataType siRes4 = SchemaMergingUtils.merge(siSource, biTarget, highestFieldId, false, true);
        assertThat(siRes4 instanceof BigIntType).isTrue();
        // SmallIntType -> FloatType
        DataType siRes5 = SchemaMergingUtils.merge(siSource, fTarget, highestFieldId, false, true);
        assertThat(siRes5 instanceof FloatType).isTrue();
        // SmallIntType -> DoubleType
        DataType siRes6 = SchemaMergingUtils.merge(siSource, dTarget, highestFieldId, false, true);
        assertThat(siRes6 instanceof DoubleType).isTrue();
        // SmallIntType -> DecimalType
        DataType siRes7 =
                SchemaMergingUtils.merge(siSource, dcmTarget, highestFieldId, false, true);
        assertThat(siRes7 instanceof DecimalType).isTrue();

        // IntType
        DataType iRes1 = SchemaMergingUtils.merge(iSource, iTarget, highestFieldId, false, true);
        assertThat(iRes1 instanceof IntType).isTrue();
        // IntType -> TinyIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        iSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // IntType -> TinyIntType with allowExplicitCast = true
        DataType iRes2 = SchemaMergingUtils.merge(iSource, tiTarget, highestFieldId, true, true);
        assertThat(iRes2 instanceof TinyIntType).isTrue();
        // IntType -> SmallIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        iSource, siTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // IntType -> SmallIntType with allowExplicitCast = true
        DataType iRes3 = SchemaMergingUtils.merge(iSource, siTarget, highestFieldId, true, true);
        assertThat(iRes3 instanceof SmallIntType).isTrue();
        // IntType -> BigIntType
        DataType iRes4 = SchemaMergingUtils.merge(iSource, biTarget, highestFieldId, false, true);
        assertThat(iRes4 instanceof BigIntType).isTrue();
        // IntType -> FloatType
        DataType iRes5 = SchemaMergingUtils.merge(iSource, fTarget, highestFieldId, false, true);
        assertThat(iRes5 instanceof FloatType).isTrue();
        // IntType -> DoubleType
        DataType iRes6 = SchemaMergingUtils.merge(iSource, dTarget, highestFieldId, false, true);
        assertThat(iRes6 instanceof DoubleType).isTrue();
        // IntType -> DecimalType
        DataType iRes7 = SchemaMergingUtils.merge(iSource, dcmTarget, highestFieldId, false, true);
        assertThat(iRes7 instanceof DecimalType).isTrue();

        // BigIntType
        DataType biRes1 = SchemaMergingUtils.merge(biSource, biTarget, highestFieldId, false, true);
        assertThat(biRes1 instanceof BigIntType).isTrue();
        // BigIntType -> TinyIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        biSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // BigIntType -> TinyIntType with allowExplicitCast = true
        DataType biRes2 = SchemaMergingUtils.merge(biSource, tiTarget, highestFieldId, true, true);
        assertThat(biRes2 instanceof TinyIntType).isTrue();
        // BigIntType -> SmallIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        biSource, siTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // BigIntType -> SmallIntType with allowExplicitCast = true
        DataType biRes3 = SchemaMergingUtils.merge(biSource, siTarget, highestFieldId, true, true);
        assertThat(biRes3 instanceof SmallIntType).isTrue();
        // BigIntType -> IntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        biSource, iTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // BigIntType -> IntType with allowExplicitCast = true
        DataType biRes4 = SchemaMergingUtils.merge(biSource, iTarget, highestFieldId, true, true);
        assertThat(biRes4 instanceof IntType).isTrue();
        // BigIntType -> FloatType
        DataType biRes5 = SchemaMergingUtils.merge(biSource, fTarget, highestFieldId, false, true);
        assertThat(biRes5 instanceof FloatType).isTrue();
        // BigIntType -> DoubleType
        DataType biRes6 = SchemaMergingUtils.merge(biSource, dTarget, highestFieldId, false, true);
        assertThat(biRes6 instanceof DoubleType).isTrue();
        // BigIntType -> DecimalType
        DataType biRes7 =
                SchemaMergingUtils.merge(biSource, dcmTarget, highestFieldId, false, true);
        assertThat(biRes7 instanceof DecimalType).isTrue();

        // FloatType
        DataType fRes1 = SchemaMergingUtils.merge(fSource, fTarget, highestFieldId, false, true);
        assertThat(fRes1 instanceof FloatType).isTrue();
        // FloatType -> TinyIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        fSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // FloatType -> TinyIntType with allowExplicitCast = true
        DataType fRes2 = SchemaMergingUtils.merge(fSource, tiTarget, highestFieldId, true, true);
        assertThat(fRes2 instanceof TinyIntType).isTrue();
        // FloatType -> SmallIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        fSource, siTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // FloatType -> IntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        fSource, iTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // FloatType -> IntType with allowExplicitCast = true
        DataType fRes4 = SchemaMergingUtils.merge(fSource, iTarget, highestFieldId, true, true);
        assertThat(fRes4 instanceof IntType).isTrue();
        // FloatType -> BigIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        fSource, biTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // FloatType -> DoubleType
        DataType fRes6 = SchemaMergingUtils.merge(fSource, dTarget, highestFieldId, false, true);
        assertThat(fRes6 instanceof DoubleType).isTrue();
        // FloatType -> DecimalType
        DataType fRes7 = SchemaMergingUtils.merge(fSource, dcmTarget, highestFieldId, false, true);
        assertThat(fRes7 instanceof DecimalType).isTrue();

        // DoubleType
        DataType dRes1 = SchemaMergingUtils.merge(dSource, dTarget, highestFieldId, false, true);
        assertThat(dRes1 instanceof DoubleType).isTrue();
        // DoubleType -> TinyIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dSource, tiTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DoubleType -> SmallIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dSource, siTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DoubleType -> SmallIntType with allowExplicitCast = true
        DataType dRes3 = SchemaMergingUtils.merge(dSource, siTarget, highestFieldId, true, true);
        assertThat(dRes3 instanceof SmallIntType).isTrue();
        // DoubleType -> IntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dSource, iTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DoubleType -> BigIntType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dSource, biTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DoubleType -> BigIntType with allowExplicitCast = true
        DataType dRes5 = SchemaMergingUtils.merge(dSource, biTarget, highestFieldId, true, true);
        assertThat(dRes5 instanceof BigIntType).isTrue();
        // DoubleType -> FloatType
        assertThatThrownBy(
                        () ->
                                SchemaMergingUtils.merge(
                                        dSource, fTarget, highestFieldId, false, true))
                .isInstanceOf(UnsupportedOperationException.class);
        // DoubleType -> DecimalType
        DataType dRes7 = SchemaMergingUtils.merge(dSource, dcmTarget, highestFieldId, false, true);
