...
public class IndexedSplitTest {
    ...
    public void testSerializeAndDeserializeWithoutScores() throws IOException {
        ...
        // Verify
        assertThat(deserialized.dataSplit().snapshotId()).isEqualTo(1L);
        assertThat(deserialized.dataSplit().bucket()).isEqualTo(0);
        assertThat(deserialized.dataSplit().bucketPath()).isEqualTo("bucket-0");
        assertThat(deserialized.dataSplit().dataFiles()).hasSize(2);
        assertThat(deserialized.rowRanges()).hasSize(2);
        assertThat(deserialized.rowRanges().get(0)).isEqualTo(new Range(0, 100));
        assertThat(deserialized.rowRanges().get(1)).isEqualTo(new Range(200, 300));
        assertThat(deserialized.scores()).isNull();
        assertThat(deserialized.rowCount()).isEqualTo(202); // (100-0+1) + (300-200+1)
    }
    ...
    public void testSerializeAndDeserializeWithScores() throws IOException {
        ...
        // Verify
        assertThat(deserialized.dataSplit().snapshotId()).isEqualTo(2L);
        assertThat(deserialized.dataSplit().bucket()).isEqualTo(1);
        assertThat(deserialized.rowRanges()).hasSize(2);
        assertThat(deserialized.rowRanges().get(0)).isEqualTo(new Range(0, 50));
        assertThat(deserialized.rowRanges().get(1)).isEqualTo(new Range(100, 150));
        assertThat(deserialized.scores()).isNotNull();
        assertThat(deserialized.scores()).hasSize(2);
        assertThat(deserialized.scores()[0]).isEqualTo(0.8f);
        assertThat(deserialized.scores()[1]).isEqualTo(0.9f);
        assertThat(deserialized.rowCount()).isEqualTo(102); // (50-0+1) + (150-100+1)
    }
    ...
    public void testJavaSerializationWithoutScores() throws IOException, ClassNotFoundException {
        ...
        // Verify
        assertThat(deserialized.dataSplit().snapshotId()).isEqualTo(3L);
        assertThat(deserialized.dataSplit().bucket()).isEqualTo(2);
        assertThat(deserialized.rowRanges()).hasSize(1);
        assertThat(deserialized.rowRanges().get(0)).isEqualTo(new Range(10, 20));
        assertThat(deserialized.scores()).isNull();
        assertThat(deserialized.rowCount()).isEqualTo(11); // (20-10+1)
    }
    ...
    public void testJavaSerializationWithScores() throws IOException, ClassNotFoundException {
        ...
        // Verify
        assertThat(deserialized.dataSplit().snapshotId()).isEqualTo(4L);
        assertThat(deserialized.dataSplit().bucket()).isEqualTo(3);
        assertThat(deserialized.dataSplit().dataFiles()).hasSize(2);
        assertThat(deserialized.rowRanges()).hasSize(3);
        assertThat(deserialized.rowRanges().get(0)).isEqualTo(new Range(5, 10));
        assertThat(deserialized.rowRanges().get(1)).isEqualTo(new Range(20, 30));
        assertThat(deserialized.rowRanges().get(2)).isEqualTo(new Range(100, 200));
        assertThat(deserialized.scores()).isNotNull();
        assertThat(deserialized.scores()).hasSize(3);
        assertThat(deserialized.scores()[0]).isEqualTo(0.5f);
        assertThat(deserialized.scores()[1]).isEqualTo(0.7f);
        assertThat(deserialized.scores()[2]).isEqualTo(0.9f);
        assertThat(deserialized.rowCount()).isEqualTo(118); // (10-5+1) + (30-20+1) + (200-100+1)
    }
    ...
    public void testUnsupportedVersion() throws IOException {
        ...
        outputView.writeLong(-938472394838495695L);
        // Write wrong version
        outputView.writeInt(999);
        ...
        assertThatThrownBy(() -> IndexedSplit.deserialize(inputView))
                .isInstanceOf(IOException.class)
                .hasMessageContaining("Unsupported IndexedSplit version");
    }
