...
public class DataEvolutionSplitRead implements SplitRead<InternalRow> {
    ...
    @Override
    public SplitRead<InternalRow> withRowRange(@Nullable RowRange rowRange) {
    ...
    private RecordReader<InternalRow> createFieldBunchReader(
        ...
        if (bunch instanceof DataBunch) {
            ...
            RecordReader<InternalRow> vectorReader =
                    sequentialReadFiles(
                            bunch.files(),
                            partition,
                            dataFilePathFactory,
            ...
            RecordReader<InternalRow> blobReader =
    ...
    private RecordReader<InternalRow> createFileReader(
        ...
        if (fileIndexReadEnabled || fileRowRange != null) {
            ...
            // implies !hasFilter; push the local range as a selection bitmap so the format reader
            // can prune row groups by both endpoints. Otherwise the regular file-index path runs.
