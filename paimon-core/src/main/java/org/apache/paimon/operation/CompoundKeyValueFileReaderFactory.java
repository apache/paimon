...
/** A specific implementation about {@link KeyValueFileReaderFactory} for compound split. */
public class CompoundKeyValueFileReaderFactory extends KeyValueFileReaderFactory {
    ...
    protected TableSchema getDataSchema(DataFileMeta fileMeta) {
        // todo: support get data schema cross branch
        return null;
    }

    @Override
    protected BinaryRow getReadPartition() {
        // todo: support get read partition cross branch and partition
