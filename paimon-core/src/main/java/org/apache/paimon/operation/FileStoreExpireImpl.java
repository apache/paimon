...
public class FileStoreExpireImpl implements FileStoreExpire {
    ...
    private final boolean dataDirectoriesIgnoreClean;
    ...
    public FileStoreExpireImpl(
            ...
            int expireLimit,
            boolean dataDirectoriesIgnoreClean) {
        ...
        this.dataDirectoriesIgnoreClean = dataDirectoriesIgnoreClean;
    }
