...
public class FileStoreExpireImpl implements FileStoreExpire {
    ...
    private final boolean snapshotExpireIgnoreCleanDirectories;
    ...
    public FileStoreExpireImpl(
        ...
        this.snapshotExpireIgnoreCleanDirectories = snapshotExpireIgnoreCleanDirectories;
    }
    ...
    public void expireUntil(long earliestId, long endExclusiveId) {
        ...
        if (snapshotExpireIgnoreCleanDirectories) {
