...
/** The action of FromTimestamp clone. */
public class FromTimestampSnapshotCloneTypeAction extends AbstractCloneTypeAction {

    private final Long timestamp;

    public FromTimestampSnapshotCloneTypeAction(Long timestamp) {
