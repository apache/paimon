...
public class ReadContext {
    ...
    public static class Builder {
        ...
        public ReadContext.Builder withLogicalPartition(BinaryRow logicalPartition) {
        ...
        public ReadContext build() {
            return new ReadContext(logicalPartition, fileBucketPathMapping, fileBranchPathMapping);
        }
    }
}
