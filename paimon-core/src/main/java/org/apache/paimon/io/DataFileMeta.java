...
public class DataFileMeta {
    ...
    public static final RowType SCHEMA =
            new RowType(
                    ...
                    Arrays.asList(
                            ...
                            new DataField(18, "_ROW_ID_SEQUENCE", newBytesType(true))));
    ...
    private @Nullable RowIdSequence rowIdSequence;
    ...
    public static DataFileMeta forAppend(
            ...
            @Nullable RowIdSequence rowIdSequence) {
    ...
    public DataFileMeta(
        ...
        this.rowIdSequence = rowIdSequence;
    }

    public void setRowIdSequence(@Nullable RowIdSequence rowIdSequence) {
        this.rowIdSequence = rowIdSequence;
    }
    ...
    @Nullable
    public RowIdSequence rowIdSequence() {
    ...
    public String toString() {
        return String.format(
                "{fileName: %s, fileSize: %d, rowCount: %d, embeddedIndex: %s, "
                        ...
                        + "deleteRowCount: %d, fileSource: %s, valueStatsCols: %s, externalPath: %s, rowIdSequence: %s}",
                fileName,
                fileSize,
                rowCount,
