...
public class DataFileMeta {
    ...
    public static final RowType SCHEMA =
            new RowType(
                    ...
                    Arrays.asList(
                            ...
                            new DataField(
                                    19, "_FIELD_IDS", new ArrayType(true, new IntType(false)))));
    ...
    private final @Nullable int[] fieldIds;
    ...
    public String toString() {
        return String.format(
                "{fileName: %s, fileSize: %d, rowCount: %d, embeddedIndex: %s, "
                        ...
                        + "deleteRowCount: %d, fileSource: %s, valueStatsCols: %s, externalPath: %s, firstRowId: %s, fieldIds: %s}",
                fileName,
                fileSize,
                rowCount,
