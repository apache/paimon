 ...
 *
 * <ul>
 *   <li>Since paimon 0.2 and paimon 0.3, commitIdentifier is changed from a String to a long
 *       value. For paimon < 0.2, only Flink connectors have paimon sink and they use checkpointId
