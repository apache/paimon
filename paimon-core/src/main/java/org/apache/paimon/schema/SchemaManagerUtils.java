...
final class SchemaManagerUtils {
    ...
    static DataType getRootType(DataType type, int currDepth, int maxDepth) {
    ...
    static DataType getArrayMapTypeWithTargetTypeRoot(
    ...
    static void assertNullabilityChange(
    ...
    static Map<String, String> applyRenameColumnsToOptions(
    ...
    static List<String> applyNotNestedColumnRename(
    ...
    static void dropColumnValidation(TableSchema schema, DropColumn change) {
    ...
    static void assertNotUpdatingPrimaryKeys(
            TableSchema schema, String[] fieldNames, String operation) {
    ...
    static void assertNotRenamingBlobColumn(List<DataField> fields, String[] fieldNames) {
        if (fieldNames.length > 1) {
            return;
        }
        String fieldName = fieldNames[0];
    ...
    static void assertNotUpdatingPrimaryKeyIndexColumn(
            TableSchema schema, String[] fieldNames, String operation) {
        if (fieldNames.length > 1) {
            return;
        }
    ...
    static void assertNotChangingBlobColumnType(
    ...
    private abstract static class NestedColumnModifier {
        ...
        NestedColumnModifier(String[] updateFieldNames, LazyField<Identifier> identifier) {
    ...
    static void updateNestedColumn(
