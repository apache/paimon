...
public class ChangelogEventMetadataTable implements DataTable, ReadonlyTable {
    ...
    private final RowType extendedRowType;

    public ChangelogEventMetadataTable(FileStoreTable wrapped) {
        this.wrapped = wrapped;
        this.extendedRowType = computeExtendedRowType(wrapped, wrapped.rowType());
    }
    ...
    public InnerTableRead newRead() {
        return wrapped.newRead().withReadType(extendedRowType);
    }
    ...
    public DataTable switchToBranch(String branchName) {
        return new ChangelogEventMetadataTable(wrapped.switchToBranch(branchName));
    }

    @Override
    public Table copy(Map<String, String> dynamicOptions) {
        return new ChangelogEventMetadataTable(wrapped.copy(dynamicOptions));
    }
