...
public class TableCommitImpl implements InnerTableCommit {
    ...
    @Override
    public TableCommitImpl filterCommittedIgnoresLastSafeSnapshot(boolean ignoresLastSafeSnapshot) {
        commit.filterCommittedIgnoresLastSafeSnapshot(ignoresLastSafeSnapshot);
        return this;
    }
