...
public class AllTablesTable implements ReadonlyTable {
    ...
    private class AllTablesScan extends ReadOnceTableScan {
        ...
        public Plan innerPlan() {
            return () -> Collections.singletonList(new AllTableSplit(rows));
        }
    }
    ...
    private static class AllTableSplit extends SingletonSplit {
        ...
        private AllTableSplit(List<GenericRow> rows) {
            this.rows = rows;
        }
    ...
    private static class AllTablesRead implements InnerTableRead {
        ...
        public RecordReader<InternalRow> createReader(Split split) {
            ...
            List<? extends InternalRow> rows = ((AllTableSplit) split).rows;
