...
public interface InnerTableCommit extends StreamTableCommit, BatchTableCommit {
    ...
    /**
     * See {@link
     * org.apache.paimon.operation.FileStoreCommit#filterCommittedIgnoresLastSafeSnapshot}. A write
     ...
     */
    InnerTableCommit filterCommittedIgnoresLastSafeSnapshot(boolean ignoresLastSafeSnapshot);
