...
public class ContinuousNonBucketCompactorFollowUpScanner implements FollowUpScanner {

    private static final Logger LOG =
            LoggerFactory.getLogger(ContinuousNonBucketCompactorFollowUpScanner.class);
